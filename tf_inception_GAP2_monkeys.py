...
if __name__ == '__main__':
    ...
    if os.path.exists(model_dir):
        ...
        base_model = InceptionV3(weights='imagenet', include_top=False,
                                 input_shape=(224, 224, 3))  # exclude top layers and last global pooling layer
        ...
        history_path = os.path.join(os.getcwd(), 'models', 'monkeys', "history_" + model_name +"_1.json")
